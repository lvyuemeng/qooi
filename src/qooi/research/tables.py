"""Research table schemas, pattern materialization, scoring, and artifacts."""
...
def build_transition_bundle(
    ...
    *,
    ...
    none_patterns = materialize_none_event_context_patterns(
    ...
    bundle_tables = {
        ...
        "none-event-context-quality.csv": project_pattern_quality(
            scored, ("none_event_context",)
        ),
        "scored-patterns.csv": scored,
        "promotion-candidates.csv": project_promotion_candidates(scored),
    }
    return ArtifactBundle(
