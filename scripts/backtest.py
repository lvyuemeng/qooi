...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--mode",
        choices=("base", "grid", "martingale", "reverse", "hedge", "zscore_recovery"),
        default="base",
    )
    ...
    parser.add_argument(
        "--benchmark-group", choices=BENCHMARK_GROUP_CHOICES, default="baselines"
    )
    ...
    parser.add_argument("--async-refresh", action="store_true")
    parser.add_argument("--refresh-concurrency", type=int, default=3)
    ...
    parser.add_argument("--include-signal-id", default="")
    parser.add_argument("--exclude-signal-id", default="")
    ...
    parser.add_argument("--trend-period", type=int, default=96)
    parser.add_argument("--trend-return-max", type=float, default=0.03)
    parser.add_argument("--trend-return-min", type=float, default=0.01)
    parser.add_argument("--adx-max", type=float, default=25.0)
    parser.add_argument("--zbasket-adx-max", type=float, default=35.0)
    ...
    parser.add_argument("--max-per-strategy-symbol", type=int, default=0)
    ...
    parser.add_argument("--min-execution-acceptance-pct", type=float, default=0.0)
    ...
    parser.add_argument("--breakeven-after-target", action="store_true")
    parser.add_argument("--loss-cooldown-bars", type=int, default=0)

    parser.add_argument("--detail", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--diagnostics", action="store_true")
    parser.add_argument(
        "--diagnostic-mode",
        choices=("backtest", "classifier", "state"),
        default="backtest",
    )
    parser.add_argument("--diagnostics-export", default="")
    parser.add_argument(
        "--classifier-profile",
        choices=("default", "fixed", "rolling"),
        default="default",
    )
    parser.add_argument("--state-diagnostics", action="store_true")
    parser.add_argument("--state-diagnostics-export", default="")
