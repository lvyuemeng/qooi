...
qooi.scanner.workflow.run(config_path)
  ...
  -> stage(load_market)
  -> stage(classify_states)
  -> stage(outcome_frames)
  -> stage(evidence_tailtree)
  -> stage(rank_review_report)
  -> frame(observations)
  -> frame(tailtree_outcomes)
  -> frame(tailtree_evidence)
  -> frame(tailtree_selection_efficiency)
  -> frame(ranked)
  -> profile.write()
```
